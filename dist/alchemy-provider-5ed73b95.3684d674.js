...
})({"6Y2F6":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a2dfa1863684d674";
"use strict";
...
},{}],"d0gsj":[function(require,module,exports) {
 ...
 */ class AlchemyProvider extends (0, _providers.JsonRpcProvider) {
     ...
     */ static getApiKey(apiKey) {
        if (apiKey == null) return 0, _index231D6B1FJs.D;
     ...
     */ static getAlchemyNetwork(network) {
        if (network === undefined) return 0, _index231D6B1FJs.a;
        if (typeof network === "number") throw new Error(`Invalid network '${network}' provided. Network must be a string.`);
        // Guaranteed that `typeof network === 'string`.
        const isValidNetwork = Object.values((0, _index231D6B1FJs.N)).includes(network);
        if (!isValidNetwork) throw new Error(`Invalid network '${network}' provided. Network must be one of: ` + `${Object.values((0, _index231D6B1FJs.N)).join(", ")}.`);
        return network;
    }
    /**
     ...
     */ static getAlchemyConnectionInfo(network, apiKey, type) {
        const url = type === "http" ? (0, _index231D6B1FJs.g)(network, apiKey) : (0, _index231D6B1FJs.b)(network, apiKey);
        return {
            headers: (0, _index231D6B1FJs.I) ? {
                "Alchemy-Ethers-Sdk-Version": (0, _index231D6B1FJs.V)
            } : {
                "Alchemy-Ethers-Sdk-Version": (0, _index231D6B1FJs.V),
    ...
    _startPending() {
        (0, _index231D6B1FJs.l)("WARNING: Alchemy Provider does not support pending filters");
    }
    /**
     ...
     */ _send(method, params, methodName, forceBatch = false) {
        ...
        this.emit("debug", {
            action: "request",
            request: (0, _index231D6B1FJs.d)(request),
            provider: this
        });
...
},{"./index-231d6b1f.js":"6d7kK","@ethersproject/networks":"6JNhW","@ethersproject/providers":"bErvj","@ethersproject/web":"5yjI3","./api/utils":"byXgH","@ethersproject/bignumber":"ckYYW","axios":"6SddO","@ethersproject/abstract-provider":"g1jr1","@ethersproject/wallet":"2DfhD","@ethersproject/contracts":"97okZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6Y2F6"], null, "parcelRequire5dc4")

//# sourceMappingURL=alchemy-provider-5ed73b95.3684d674.js.map
