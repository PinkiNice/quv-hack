export type PlaynanceABIType = [
  {
    inputs: [
      { internalType: 'address'; name: 'newGameController'; type: 'address' }
    ];
  ...
  },
  {
    anonymous: false;
    inputs: [
      { indexed: false; internalType: 'bytes'; name: 'poolId'; type: 'bytes' },
      {
        indexed: false;
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false; internalType: 'int32'; name: 'price'; type: 'int32' },
      {
        indexed: false;
        internalType: 'uint256';
        name: 'minTradeAmount';
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'int64'; name: 'timeMS'; type: 'int64' }
    ];
    name: 'distribute';
    outputs: [];
    stateMutability: 'nonpayable';
    ...
    inputs: [
      {
        ...
        internalType: 'struct UpVsDownGameV1.makeTradeStruct';
        name: 'userTrade';
        type: 'tuple';
      }
    ];
    ...
    outputs: [
      ...
      { internalType: 'uint256'; name: 'poolBetsLimit'; type: 'uint256' },
      {
        components: [
          ...
          { internalType: 'string[]'; name: 'countries'; type: 'string[]' },
          { internalType: 'string[]'; name: 'whiteLabelIds'; type: 'string[]' },
        ...
        internalType: 'struct UpVsDownGameV1.BetGroup';
        name: 'upBetGroup';
        type: 'tuple';
      },
      {
